...
$ucrs6='<!><span style="font-size:50%">minus</span>,−,<!><span style="font-size:50%">hyphen</span>,‐,<!><span style="font-size:50%">non breaking hyphen</span>,‑,<!><span style="font-size:50%">figure dash</span>,‒,<!><span style="font-size:50%">en dash</span>,–,<!><span style="font-size:50%">em dash</span>,—,<!><span style="font-size:50%">horizontal bar</span>,―,<!><span style="font-size:50%">double hyphen</span>,⸗,‖,‗,‘,’,‚,‛,“,”,„,‟,†,‡,•,‣,․,‥,…,‧,‰,‱,′,″,‴,‵,‶,‷,‸,‹,›,※,‼,‽,‾,‿,⁀,⁁,⁂,⁃,⁄,⁅,⁆,⁇,⁈,⁉,⁊,⁋,⁌,⁍,⁎,⁏,⁐,⁑,⁒,⁓,⁔,⁕,⁖,⁗,⁘,⁙,⁚,⁛,⁜,⁝,⁞,⁠,⁡,⁢,⁣,⁤,⁥,⁦,⁧,⁨,⁩,︰,﹅,﹆,﹉,﹊,﹋,﹌,﹐,﹑,﹒,﹔,﹕,﹖,﹗,﹟,﹠,﹡,﹨,﹪,﹫,！,＂,＃,％,＆,＇,＊,，,．,／,：,；,？,＠,＼,｡,､,･';
