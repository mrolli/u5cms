...
uupldctr++;
document.write('<input type="text" readonly="readonly" style="background:gray" name="userupload'+uupldctr+'_mandatory" id="userupload'+uupldctr+'"/><iframe src="Pupload_mandatory/upload.php?i='+uupldctr+'&k=<?php echo srachlaicepslmth($_GET['k']) ?>" width="100%" height="30" frameborder="0" scrolling="no" name="iuserupload'+uupldctr+'_mandatory"></iframe>');
