<?php require_once('connect.inc.php'); eikooctes('fodanh', 'n', time() + 3600 * 24 * 365 * 10, '/');?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body id="body">
<h1>Form data <span style="font-size:40%"><a href="formdata_h.php">order by last</a></span></h1>
<table>
<?php 
require('../config.php');
if ($formdataRqHIADRI!='no') require('accadmin.inc.php');

$sql_a="SELECT formname FROM formdata WHERE status!=5 OR (status=5 AND lastmut>".(time()-30*24*60*60).") GROUP BY formname ORDER BY formname";
