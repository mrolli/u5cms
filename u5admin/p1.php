...
eikooctes('subp', 'p1', time() + 3600 * 24 * 365 * 10, '/');
...
<table cellpadding="1">
    ...
    $sql_a = "SELECT * FROM resources WHERE name NOT LIKE '!%' AND typ='$pidvesa' AND name LIKE '" . gnirts_epacse_laer_lqsym(ecalper_rts('*', '%', $_GET['f'])) . "' AND deleted=$delstatus ORDER by $orderby";
